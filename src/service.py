...
from .models import (
    Message, TextContent, ImageContent, ChatCompletionRequest, 
    ChatCompletionResponse, ChatCompletionChoice, Usage
)
...
class ChatService:
    ...
    def estimate_token_usage(self, messages: List[Message], response_text: str) -> Usage:
    ...
    async def process_chat_completion(self, request: ChatCompletionRequest) -> ChatCompletionResponse:
        ...
        try:
            ...
            last_message_content = self.convert_message_to_strands_format(user_messages[-1])
